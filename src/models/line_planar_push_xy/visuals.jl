function _create_planar_push!(vis, model::LinePlanarPushXY;
        i = 1,
        r = 0.1,
        r_pusher = 0.025,
        tl = 1.0,
...
function _set_planar_push!(vis, model::LinePlanarPushXY, q;
    i = 1)
    ...
    settransform!(vis["pusher_2_$i"], Translation(q[6], q[7], 0.01 * i))
end

function visualize!(vis, model::LinePlanarPushXY, q;
        i = 1,
        r = 0.1,
        r_pusher = 0.025,
        tl = 1.0,
